    ...
    <div id="page">
        <div id="page-bgtop">
            <div id="content">
                ...
                <div class="post">
                    <h2 class="title"><a href="/news/<?= $newItem['id'] ?>"><?= $newItem['title'] ?></a></h2>
                    <p class="byline"><?= $newItem['date'] ?></p>
                    <div class="entry">
                        <p><?= $newItem['short_content'] ?></p>
                    </div>
                    <div class="meta">
                        <p class="links"><a href="/news/<?= $newItem['id'] ?>" class="comments">Читать далее</a></p>
                    </div>
                </div>
                <?php endforeach; ?>
